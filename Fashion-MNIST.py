...
def retrain_and_evaluate(X_train, X_test, y_train, y_test):
    ...
    best_model_retrained.add_layer(DenseLayer(X_train.shape[1], 128, initialization="Glorot"))
    best_model_retrained.add_layer(Tanh())
    best_model_retrained.add_layer(DenseLayer(128, 64, initialization="Glorot"))
    best_model_retrained.add_layer(Tanh())
    best_model_retrained.add_layer(DenseLayer(64, 10, initialization="Glorot"))
